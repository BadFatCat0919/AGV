...
#define WIDGET_SWITCH_EN			0				//允许使用控件：Switch复选开关
...
//--------------【选项最大数目】
#define OPTIONS_MAX				    18				//每页最大可以容纳的选项数（不可设置太大）
...
/*---------用户需根据系统按键返回的键值来进行设定---------*/
#include "key.h"
#define	SOLGUI_KEY_UP			__KEY_UP			//上
#define SOLGUI_KEY_DOWN			__KEY_DOWN			//下
#define	SOLGUI_KEY_LEFT			__KEY_LEFT			//左
#define SOLGUI_KEY_RIGHT		__KEY_RIGHT			//右
#define SOLGUI_KEY_OK			__KEY_OK 			//确认
#define	SOLGUI_KEY_BACK			__KEY_BACK			//返回
...
//--------------【SPIN控件：上下限位数设置】
#define SPIN_DIGIT_MAX 			3				//可在SPIN中可设置的上限位数（超过5位会出错）
#define SPIN_DIGIT_MIN 			0				//可在SPIN中可设置的下限位数（精度10^-3）
